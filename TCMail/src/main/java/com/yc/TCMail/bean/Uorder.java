...
public class Uorder implements java.io.Serializable {
	...
	public Uorder(Integer id, Integer uid, String paystatu, String ordertime, Double totalprice, String visiable) {
		super();
		this.id = id;
		this.uid = uid;
	 ...
	 * public Uorder() {}
	 * 
	 * public Uorder(Integer id, Integer uid, String paystatu, String ordertime,
	 * Double totalprice, String visiable) { super(); this.id = id; this.uid = uid;
	 * this.paystatu = paystatu; this.ordertime = ordertime; this.totalprice =
	 * totalprice; this.visiable = visiable; }
	 */
	@Transient
	public User getUser() {
		return user;
	...
	/**
	 * @GeneratedValue 主键生成策略 IDENTITY 自动递增
